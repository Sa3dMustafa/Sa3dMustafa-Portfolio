...
const FLOATING_SHAPES = [
  { size: 60, x: '88%', y: '20%', color: 'rgba(26,188,156,0.08)', type: 'circle', delay: 0 },
  { size: 40, x: '3%', y: '40%', color: 'rgba(26,188,156,0.06)', type: 'square', delay: 0.5 },
  { size: 24, x: '91%', y: '55%', color: 'rgba(26,188,156,0.12)', type: 'circle', delay: 1 },
  { size: 16, x: '14%', y: '85%', color: 'rgba(26,188,156,0.15)', type: 'diamond', delay: 1.5 },
]
    ...
    <section id="hero" className="hero" ref={heroRef}>
      ...
      <div className="hero-inner">
        <div className="hero-content">
          ...
          <h1 className="hero-name" style={{ transform: `translate(${mousePos.x * -6}px, ${mousePos.y * -6}px)` }}>
            Saad
            <br />
          ...
          <p className="hero-tagline">
            ...
            <span className="highlight">polished</span> web experiences that feel effortless to use.
          </p>
