...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:saad.abdo01212@gmail.com?subject=${subject}&body=${body}`
    setStatus('sent')
            ...
            <form className="contact-form" onSubmit={handleSubmit}>
              ...
              {status === 'sent' && (
                <p className="form-success">
                  Your email app should open with the message prefilled. If it does not, contact me directly at saad.abdo01212@gmail.com.
                </p>
              )}
            </form>
          </div>
